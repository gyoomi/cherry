...
public class CyclicBarrierThreadTest {
    ...
    static class CyclicBarrierThread extends Thread {
        ...
        public void run() {
            try {
                ...
                System.out.println(this.getName() + "准备等待了，Time = " + System.currentTimeMillis());
                cb.await();
                System.out.println(this.getName() + "结束等待了，Time = " + System.currentTimeMillis());
    ...
    public static void main(String[] args) {
        ...
        CyclicBarrier barrier = new CyclicBarrier(3, rn1);
        CyclicBarrierThread cbt1 = new CyclicBarrierThread(barrier, 3);
        CyclicBarrierThread cbt2 = new CyclicBarrierThread(barrier, 6);
        CyclicBarrierThread cbt3 = new CyclicBarrierThread(barrier, 9);
        cbt1.start();
        cbt2.start();
        cbt3.start();
    }
